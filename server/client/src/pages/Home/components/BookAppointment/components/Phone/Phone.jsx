...
const Phone = () => {
    ...
    return (
        <div className="appointment-phone-container">
            ...
            <p className="appointment-phone-text">Можете да си запишете час и чрез обаждане на дадения по-горе телефон. Записвания на час по телефона се приемат от 8:30 до 17:00.</p>
        </div>
    )
}
